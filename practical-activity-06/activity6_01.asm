; A implementação de comandos de repetição em linguagem assembly, como o comando WHILE,
; é sempre feita combinando o uso de testes de condições e instruções de saltos condicionais.

; ATIVIDADE: Implementar um programa em assembly que leia n caracteres enquanto for
; diferente de CR. Contar o número de caracteres e imprimir tantos “*” quanto for este número.

title printing characters as asterisks (while) different from CR ; Título do arquivo/programa.
